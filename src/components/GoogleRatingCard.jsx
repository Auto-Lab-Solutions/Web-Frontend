  ...
  return (
    <div className="max-w-xs mx-auto bg-white rounded-lg shadow-md border-4 border-green-500 p-4 text-center">
      <div className="flex items-center justify-center mb-2">
        ...
        />
        <span className="text-lg font-semibold text-black">Google Rating</span>
      </div>

      <div className="flex items-center justify-center mb-1">
        <span className="text-2xl font-bold text-yellow-500 mr-2">{reviewsSummary.rating.toFixed(1)}</span>
        <div className="flex">
